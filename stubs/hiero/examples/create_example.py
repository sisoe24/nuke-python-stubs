...
from hiero.core import Bin, BinItem, Sequence, VideoTrack, newProject
...
def findResourcePath():
    try:
        ...
        raise RuntimeError(
            'Cannot find resource files, please set the HIERO_PYTHON_DEV_GUIDE environment variable')
