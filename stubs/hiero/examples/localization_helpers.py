...
class CustomLocalizationDialog(QtWidgets.QDialog):
    ...
    def __init__(self, itemSelection=None, parent=None):
        ...
        self._formatFilterEdit.setToolTip(
            'Enter a comma separated list of file extensions to localize, e.g. dpx, exr')
...
class CustomLocalizeMenu:
    ...
    def __init__(self):
        ...
        self._localizeBinContents = createMenuAction(
            'This Bin', self.localizeBinSelection, icon='icons:Bin.png')
        self._localizeThisBinSequence = createMenuAction(
            'This Sequence', self.localizeBinSelection, icon='icons:TimelineStroked.png')
        self._localizeBinContentsCustom = createMenuAction(
            'This Bin Custom...', self.localizeBinSelectionCustom, icon='icons:BlendingDisabled.png')
        self._localizeThisSequence = createMenuAction(
            'This Sequence', self.localizeTimelineSpreadsheetSequence, icon='icons:TimelineStroked.png')
        self._localizeThisTrack = createMenuAction(
            'This Track', self.localizeTimelineSpreadsheetSelection, icon='icons:Tracks.png')
