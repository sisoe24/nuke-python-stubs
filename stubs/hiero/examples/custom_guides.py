...
titleSafeGuide = hiero.ui.guides.SimpleGuide(
    'Custom Title Safe', 0.0, 1.0, 0.1, 1, hiero.ui.guides.kGuideMasked)
actionSafeGuide = hiero.ui.guides.SimpleGuide(
    'Custom Action Safe', 1, 1, 1, 1, hiero.ui.guides.kGuideMasked, crosshairs=True)
sequenceFormatGuide = hiero.ui.guides.SimpleGuide(
    'Custom Sequence Format', 1, 1, 0, 1, hiero.ui.guides.kGuideSequence, crosshairs=False)
