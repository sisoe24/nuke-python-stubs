...
class EDLExportUI(hiero.ui.TaskUIBase):
    ...
    def populateUI(self, widget, exportTemplate):
        ...
        absPathCheckbox.setToolTip(
            'Enable to use the absolute file path for filenames instead of just the filename part.')
        ...
        truncateCheckBox.setToolTip(
            'Enable to truncate reel names to 8 characters (required by some applications).')
