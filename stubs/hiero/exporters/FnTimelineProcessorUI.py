...
class TimelineProcessorUI(hiero.ui.ProcessorUIBase, QtCore.QObject):
    ...
    def __init__(self, preset):
        ...
        hiero.ui.ProcessorUIBase.__init__(
            self, preset, itemTypes=hiero.core.TaskPresetBase.kSequence)
    ...
    def validateSelection(self, exportItems):
        ...
        hiero.core.log.debug('validateSelection TimelineProcessor ' +
                             str(len(invalidItems) < len(exportItems)))
    ...
    def createProcessorSettingsWidget(self, exportItems):
        ...
        fullRadioButton = QtWidgets.QRadioButton(
            'Selected Track Items' if exportSelection else 'Whole Sequence')
        fullRadioButton.setToolTip(
            selectedTrackItemsToolTip if exportSelection else wholeSequenceToolTip)
