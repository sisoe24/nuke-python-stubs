...
from .FnExternalRender import (kPerShot, kDisabled, kPerTrack, kPerSequence,
                               kUnconnected)
...
class AdditionalNodesDialog (QtWidgets.QDialog):
    ...
    class ItemModel (QtCore.QAbstractItemModel):
        ...
        class Element(QtCore.QObject):
            ...
            def __init__(self, parent, location=None, tags=[], script=None, available_tags=[]):
                ...
                self._removeWidget = QtWidgets.QPushButton(
                    QtGui.QIcon('icons:ExportCancel.png'), '')
    ...
    def init_ui(self):
        ...
        clearButton = self._standardButtons.addButton(
            'Clear', QtWidgets.QDialogButtonBox.ActionRole)
