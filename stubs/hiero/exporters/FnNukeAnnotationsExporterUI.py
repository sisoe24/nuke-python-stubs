...
class NukeAnnotationsExporterUI(hiero.ui.TaskUIBase):
    ...
    def __init__(self, preset):
        super(NukeAnnotationsExporterUI, self).__init__(
            FnNukeAnnotationsExporter.NukeAnnotationsExporter, preset, 'Nuke Annotations File')
...
hiero.ui.taskUIRegistry.registerTaskUI(
    FnNukeAnnotationsExporter.NukeAnnotationsPreset, NukeAnnotationsExporterUI)
