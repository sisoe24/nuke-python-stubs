...
class TrackItemExportScriptWriter(object):
    ...
    def writeToScript_old(self, script):
        ...
        keepSourceFormat = (itemReformatState.type() in (
            nuke.ReformatNode.kDisabled, nuke.ReformatNode.kToScale))
        ...
        formatForSequenceEffects = (keepSourceFormat and (
            writeSequenceEffects or writeSequenceAnnotations))
    ...
    def _writeSequenceTimecodeMetadata(self, script, effectOffset):
        ...
        metadata = {'hiero/sequence/timecode': '[make_timecode %s %s %d]' % (
