...
from hiero.core import (TaskBase, TaskPresetBase, FolderTaskPreset,
                        IExportStructure, IExportStructureElement, log,
                        taskRegistry)
...
class ExportStructureElement (IExportStructureElement):
    ...
    def setPreset(self, preset):
        ...
        assert (preset is None or isinstance(preset, TaskPresetBase)
                ), 'unexpected type %s' % type(preset)
        self._preset = preset
