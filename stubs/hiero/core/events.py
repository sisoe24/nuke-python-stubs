...
# triggered after switching between the timeline, node graph and other views
registerEventType('kContextChanged')
...
# triggered when a right-click context menu is shown in a view.
registerEventType('kShowContextMenu')
