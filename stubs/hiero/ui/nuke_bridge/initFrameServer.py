...
from hiero.ui.nuke_bridge.FnNsFrameServer import (stopServer, startServer,
                                                  isServerRunning)
...
def isFrameServerEnabled():
    ...
    disabledByEnvVar = int(os.environ.get(
        FRAMESERVER_DISABLED_ENV, FRAMESERVER_DISABLED_ENV_DEFAULT))
    ...
    if isFrameServerEnabled():
        if not isServerRunning():
            ...
            hiero.core.events.registerInterest(
                hiero.core.events.EventType.kShutdownFinal, stopServer)
