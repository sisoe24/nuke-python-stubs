...
import hiero.core
from foundry.frameserver.nuke import errorhandler
from foundry.frameserver.nuke import postprocessscript as postProcessScript
...
postProcessServer.start(nukePath, scriptPath, pathRemaps, errorhandler.FrameserverErrorHandler(
    FnNsFrameServer.onFatalError, FnNsFrameServer.onError))
