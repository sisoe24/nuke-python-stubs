...
from hiero.core.FnFloatRange import (Default, IntRange, CustomList, FloatRange,
                                     QuicktimeCodec, QuicktimeSettings)
    ...
    def setSliderValue(self, value):
        ...
        if self.isIntRange():
            ...
            self._slider.setValue(
                int((float(SliderProperty.__floatSliderMax) / float(self._value.range())) * value))
...
UIPropertyBase.register((hiero.core.FnFloatRange.FloatRange,
                        hiero.core.FnFloatRange.IntRange), SliderProperty)
...
class ViewsPropertyWidget(UIPropertyBase):
    ...
    def update(self, commit=False):
        if commit:
            ...
            def isViewSelected(view): return (
                selectedViews == hiero.core.RenderTaskPreset.AllViews()) or view in selectedViews
