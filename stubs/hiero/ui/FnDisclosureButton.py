...
class DisclosureButton(QtWidgets.QCheckBox):
    ...
    def paintEvent(self, event):
        ...
        subStyleOption.rect = style.subElementRect(
            QtWidgets.QStyle.SE_CheckBoxIndicator, styleOption, self)
        brush = QtCore.Qt.black if self.isEnabled() else self.palette().color(
            QtGui.QPalette.Disabled, QtGui.QPalette.Light)
