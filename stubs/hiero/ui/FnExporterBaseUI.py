...
class RenderTaskUIBase(TaskUIBase):
    ...
    def reformatChanged(self):
        ...
        widgetEnabledMap = ((self._formatChooser, text == nuke.ReformatNode.kCustomLabel),
                            ...
                            (self._resizeWidget, text in (
                                nuke.ReformatNode.kCustomLabel, nuke.ReformatNode.kToScaleLabel)),
    ...
    def createChannelsWidget(self, layout):
        ...
        name, label, value = 'channels', 'Channels:', CustomList(
            'all', 'rgb', 'rgba', 'alpha', 'depth', default='rgb')
        ...
        uiProperty = UIPropertyFactory.create(type(
            value), key=name, value=value, dictionary=self._preset.properties(), label=label, tooltip=channelsToolTip)
