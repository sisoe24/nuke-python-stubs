from hiero.core import EffectTrackItem, events, findItemByGuid

from . import messages
from .log import logMessage
from .synctool import SyncTool, localCallback, remoteCallback

messages.defineMessageType('EffectItemKnobChange', ('itemGuid', str),
...
messages.addMessageFilter(messages.RemoveDuplicateMessagesFilter(
    messages.EffectItemKnobChange, matchAttributes=('itemGuid', 'knobName')))
...
class SyncEffectItemKnobsTool(SyncTool):
    ...
    def __init__(self, messageDispatcher):
        ...
        messageDispatcher._registerCallback(
            messages.EffectItemKnobChange, self._onRemoteKnobChanged)
        self.registerEventCallback(
            events.EventType.kEffectItemKnobChanged, self._onLocalKnobChanged)
    ...
    def _onRemoteKnobChanged(self, msg):
        ...
        if not knob:
            logMessage(
                'SyncEffectItemKnobsTool._onRemoteKnobChanged knob {} not found!'.format(msg.knobName))
            return
