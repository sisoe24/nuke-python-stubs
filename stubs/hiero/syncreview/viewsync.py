import hiero.ui
import hiero.core
from hiero.ui import Player, Viewer, TracksMask
...
class SyncViewerAnnotationTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerAnnotationsTool, self.onRemoteAnnotationsToolChanged)
    ...
    def pushState(self):
        if self._viewerAnnotationTool:
            msg = messages.SyncViewerAnnotationsTool(
                active=int(self._viewerAnnotationTool.isActive()))
...
class SyncViewerPlaybackModeTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerPlaybackMode, self._onRemotePlaybackModeChanged)
...
class SyncViewerGammaTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerGamma, self._onRemoteGammaChanged)
...
class SyncViewerCompareModeTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerCompareMode, self._onRemoteCompareModeChanged)
...
class SyncViewerLayoutModeTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerLayoutMode, self._onRemoteLayoutModeChanged)
...
class SyncViewerBufferTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerBuffer, self._onRemoteBufferChanged)
...
messages.defineMessageType('SyncViewerWipeToolState', ('translateX', float),
                           ('translateY', float), ('gauge', float), ('rotation', float))
...
class SyncViewerWipeTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self._wipeTool = None
        self.messageDispatcher._registerCallback(
            messages.SyncViewerWipeToolState, self._onRemoteWipeStateChanged)
    ...
    def pushState(self):
        ...
        msg = messages.SyncViewerWipeToolState(
            translateX=wipeState.translateX, translateY=wipeState.translateY, gauge=wipeState.gauge, rotation=wipeState.rotation)
        self.messageDispatcher.sendMessage(msg)

    @remoteCallback
    def _onRemoteWipeStateChanged(self, msg):
        wipeToolState = hiero.ui.WipeToolState(
            msg.translateX, msg.translateY, msg.gauge, msg.rotation)
...
class SyncViewerLayerTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerLayerState, self._onRemoteLayerChanged)
...
class SyncViewerChannelsTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerChannels, self._onRemoteChannelsChanged)
...
class SyncViewerZoomTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerZoom, self._onRemoteTransformChanged)
...
class SyncViewerTimeDisplayFormatTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self._handlingRemoteChange = False
        self.messageDispatcher._registerCallback(
            messages.SyncViewerTimeDisplayFormat, self._onRemoteFormatChanged)
...
messages.defineMessageType('SyncViewerGuideOverlay', ('guideOverlayNames',
                           messages.Json), ('availableGuideOverlays', messages.Json))
...
class SyncViewerGuideOverlayTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerGuideOverlay, self._onRemoteGuideOverlayChanged)
    ...
    def pushState(self):
        ...
        msg = messages.SyncViewerGuideOverlay(
            guideOverlayNames=guideOverlays, availableGuideOverlays=availableOverlays)
        self._syncViewerTool.sendMessage(msg)
...
class SyncViewerMaskOverlayTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerMaskOverlay, self._onRemoteMaskOverlayChanged)
...
class SyncViewerMaskOverlayStyleTool(SyncViewerSubTool):
    ...
    def __init__(self, syncViewerTool):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerMaskOverlayStyle, self._onRemoteMaskOverlayStyleChanged)
...
class SyncViewerTool(SyncTool):
    ...
    def __init__(self, messageDispatcher):
        ...
        self.messageDispatcher._registerCallback(
            messages.SyncViewerTargetFrameRate, self._onSyncTargetFrameRate)
        self.messageDispatcher._registerCallback(
            messages.SyncViewerShuttleTargetFPS, self._onSyncViewerShuttleTargetFPS)
    ...
    def _onSyncSequence(self, msg):
        ...
        if newSequenceGuids != self._currentSequenceGuids:
            seqA = hiero.core.findItemByGuid(msg.sequenceAGuid, filter=[
                                             hiero.core.Sequence, hiero.core.Clip]) if msg.sequenceAGuid else None
            seqB = hiero.core.findItemByGuid(msg.sequenceBGuid, filter=[
                                             hiero.core.Sequence, hiero.core.Clip]) if msg.sequenceBGuid else None
            ...
            if msg.sequenceAGuid and not seqA:
                logMessage('_onSyncSequence could not find sequence A with id {}'.format(
                    msg.sequenceAGuid))
            if msg.sequenceBGuid and not seqB:
                logMessage('_onSyncSequence could not find sequence B with id {}'.format(
                    msg.sequenceBGuid))
    ...
    def updateCurrentSequences(self):
        ...
        newSequenceGuids = ['' if not sequenceA else sequenceA.guid(
        ), '' if not sequenceB else sequenceB.guid()]
