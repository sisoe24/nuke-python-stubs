...
class CameraFilmBackPresets:
    ...
    def __init__(self):
        ...
        self.addPreset('Canon/DSLR/Rebel 550D 600D 650D T2i T3i T4i Still',
                       {'filmBackSize': '22.3 14.9'})
        self.addPreset('Canon/DSLR/Rebel 550D 600D 650D T2i T3i T4i Video',
                       {'filmBackSize': '22.3 12.54'})
