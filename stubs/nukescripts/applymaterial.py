...
class ObjectNameChooserDialog(nukescripts.panels.PythonPanel):
    ...
    def __init__(self, names):
        nukescripts.panels.PythonPanel.__init__(
            self, 'Object Name Chooser', 'uk.co.thefoundry.ObjectNameChooserDialog')
...
def chooseObjectName(amfNode):
    ...
    if result:
        ...
        # Work around for Bug 36107 - SceneView_Knob trims leading '/' from strings. Remove this when that bug is fixed.
        name = _workaroundForBug36107(name, names)
