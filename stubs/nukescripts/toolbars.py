...
def setup_toolbars():
    ...
    m.addCommand('Read', 'nukescripts.create_read()', 'r',
                 icon='Read.png', shortcutContext=dagContext)
    m.addCommand('Write', "nuke.createNode(\"Write\")", 'w',
                 icon='Write.png', shortcutContext=dagContext)
    m.addCommand('Profile', "nuke.createNode(\"Profile\")",
                 icon='Write.png', shortcutContext=dagContext)
    if not assist:
    ...
    m.addCommand('Roto', '''nuke.createNode("Roto")''', 'o',
                 icon='Roto.png', shortcutContext=dagContext)
    ...
    m.addCommand('RolloffContrast', "nuke.createNode(\"RolloffContrast\")",
    ...
    m.addCommand(
        'Keylight', 'nuke.createNode("OFXuk.co.thefoundry.keylight.keylight_v201")', icon='Keylight.png')
    ...
    if not assist:
        n.addCommand(
            'Plus', "nuke.createNode(\"Merge2\", \"operation plus name Plus\", False)", icon='MergePlus.png')
        n.addCommand(
            'Matte', "nuke.createNode(\"Merge2\", \"operation matte name Matte\", False)", icon='MergeMatte.png')
        n.addCommand(
            'Multiply', "nuke.createNode(\"Merge2\", \"operation multiply name Multiply\", False)", icon='MergeMultiply.png')
        n.addCommand(
            'In', "nuke.createNode(\"Merge2\", \"operation in name In\", False)", icon='MergeIn.png')
        n.addCommand(
            'Out', "nuke.createNode(\"Merge2\", \"operation out name Out\", False)", icon='MergeOut.png')
        n.addCommand(
            'Screen', "nuke.createNode(\"Merge2\", \"operation screen name Scrn\", False)", icon='MergeScreen.png')
        n.addCommand(
            'Max', "nuke.createNode(\"Merge2\", \"operation max name Max\", False)", icon='MergeMax.png')
        n.addCommand(
            'Min', "nuke.createNode(\"Merge2\", \"operation min name Min\", False)", icon='MergeMin.png')
        n.addCommand('Absminus', "nuke.createNode(\"Merge2\", \"operation difference name Difference\", False)",
                     icon='MergeDifference.png')
        m.addCommand('MergeExpression', "nuke.createNode(\"MergeExpression\")",
    ...
    m.addCommand('Transform', "nuke.createNode(\"Transform\")",
    ...
    m.addCommand('GridWarpTracker', "nuke.createNode(\"GridWarpTracker\")",
