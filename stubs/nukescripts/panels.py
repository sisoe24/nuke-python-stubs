...
class PythonPanel(pyui.Dialog):
    ...
    def addCallback(self):
        nuke.addKnobChanged(PythonPanelKnobChanged, args=self,
                            nodeClass='PanelNode', node=self.__node)

    def removeCallback(self):
        nuke.removeKnobChanged(PythonPanelKnobChanged, args=self,
                               nodeClass='PanelNode', node=self.__node)
    ...
    class Panel(PythonPanel):
        ...
        def __init__(self, widget, name, id):
            ...
            self.customKnob = nuke.PyCustom_Knob(
                name, '', "__import__('nukescripts').panels.WidgetKnob(" + widget + ')')
