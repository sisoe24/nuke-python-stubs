...
class ScriptInputArea(PySide2.QtWidgets.QPlainTextEdit, PySide2.QtCore.QObject):
    ...
    def resizeEvent(self, event):
        ...
        self._lineNumberArea.setGeometry(PySide2.QtCore.QRect(
    ...
    def ExtendSelectionToCompleteLines(self, tc):
        ...
        if (lPos >= lAnchor):
            ...
            tc.movePosition(PySide2.QtGui.QTextCursor.PreviousCharacter,
                            PySide2.QtGui.QTextCursor.KeepAnchor)
            lSelected = tc.selectedText()
    ...
    def completeTokenUnderCursor(self, token):
        ...
        if self._completer.popup().isVisible():
            ...
            rect.setWidth(self._completer.popup().sizeHintForColumn(
